...
setup(name='qp-ivar-consensus',
      version=__version__,
      long_description=long_description,
      license="BSD",
      description='Qiita Plugin: qp-ivar-consensus',
      author="Grant Cheng",
      author_email="gxcheng@ucsd.edu",
      url='https://github.com/CatFish47/qp-ivar-consensus/',
      test_suite='nose.collector',
      packages=['qp_ivar_consensus'],
      package_data={'qp_ivar_consensus': [
