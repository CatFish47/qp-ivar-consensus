...
from qp_ivar_consensus.qp_ivar_consensus import (
    _generate_commands, ivar_consensus_to_array,
    SORT_CMD)
...
class SamtoolsSortTests(PluginTestCase):
    ...
    def test_generate_commands(self):
        ...
        unsorted_bams = ['untrimmed1.unsorted.bam', 'untrimmed2.unsorted.bam',
                         'trimmed1.unsorted.bam', 'trimmed2.unsorted.bam']

        obs = _generate_commands(unsorted_bams, params['nprocs'],
                                 params['out_dir'])
        cmd = SORT_CMD.format(**params)
        ecmds = [cmd % (bam, bam) for bam in unsorted_bams]
    ...
    def test_ivar_consensus(self):
        ...
        ub_1 = join(in_dir, 'CALM_SEP_001974_81_S382_L002.trimmed.unsorted.bam')
        ub_2 = join(in_dir, 'CALM_SEP_001974_82_S126_L001.trimmed.unsorted.bam')
        ...
        copyfile(f'{source_dir}/CALM_SEP_001974_81_S382_L002.trimmed.unsorted.bam', ub_1)
        copyfile(f'{source_dir}/CALM_SEP_001974_82_S126_L001.trimmed.unsorted.bam', ub_2)
        ...
        exp_out_files = [
            f'{out_dir}/CALM_SEP_001974_81_S382_L002.trimmed.unsorted.bam\tunsorted_bam\n',
            f'{out_dir}/CALM_SEP_001974_82_S126_L001.trimmed.unsorted.bam\tunsorted_bam\n']
        ...
        exp_commands = [
            'samtools sort CALM_SEP_001974_81_S382_L002.trimmed.unsorted.bam '
